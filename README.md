...
- Workloads run as UID/GID `65532` inside the gVisor sandbox. This lets images
  declared with root as their default user pass restricted Pod Security without
