...
- Privileged containers, host networking, host mounts, added Linux
  ...
  operator.
- Every workload is ingress- and egress-isolated. Only declared inbound ports
  are exposed; outbound DNS remains available while Pod, Service, LAN,
...
```json
{
  ...
  "image": "ghcr.io/ipa-cyberlab/ipa-rs-heterocloud-flash:0.1.22",
  "replicas": 3,
  "cpu_millis": 250,
  "memory_mib": 128,
